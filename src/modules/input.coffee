...
class exports.Input extends Layer
	...
	constructor: (options = {}) ->
		...
		@input.style.cssText = "outline: none; font-size: #{options.fontSize}px; line-height: #{options.lineHeight}px; padding: #{options.padding}px; width: #{options.width}px; height: #{options.height}px; border-radius: #{options.radius}px; border: none; background-image: url(about:blank); background-color: #{options.backgroundColor};"
